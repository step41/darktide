...
local SUPPORTED_THROW_TEMPLATES = {
	...
	-- arc_grenade.lua is generated by the same grenade_weapon_template_generator("grenade_ability")
	-- call as adamant_grenade.lua, with an identical actions/action_inputs shape — same
	-- numeric-shorthand entry applies.
	arc_grenade = DEFAULT_THROW_DELAY_S,
